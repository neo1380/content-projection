...
import { IPdfViewerModule } from './ipdfviewer.module';

@Component({
  template: `
    <ipdf-viewer></ipdf-viewer>
  `
})
class TestComponent {}

describe('AppComponent', () => {
  let pdfViewerFixture: ComponentFixture<IPdfViewerComponent>;
  let pdfViewer: IPdfViewerComponent;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      .then(() => {
        ...
        pdfViewerFixture = TestBed.createComponent(IPdfViewerComponent);
  ...
  describe('getScale', () => {
    it('should get scale 1 with viewportWidth = 0 or viewerContainerWidth = 0', function() {
      ...
      let spy = spyOnProperty(
        (pdfViewer as any).ipdfViewerContainer.nativeElement,
        'clientWidth',
        'get'
      ).and.returnValue(0);
